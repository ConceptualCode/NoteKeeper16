...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String ORIGINAL_NOTE_COURSE_ID = "com.exampe.notekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE = "com.example.notekeeper.ORINAL_NOTE_TITLE";
    ...
    private void sendEmail() {
        ...
        String text = "Checl out what I learn on the Plurasight course \"" +
